...
class Misc(commands.Cog):
    ...
    @slash_command(description="I LOVE LEAN!!!!", guild_ids=mains)
    async def lean(self, interaction: Interaction):
        await interaction.response.send_message("**I LOVE LEAN!!!!**")

    @slash_command(description="Gets a random Kanye quote", guild_ids=mains)
    ...
    @slash_command(description="Gets a random neko image", guild_ids=mains)
